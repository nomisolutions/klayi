...
- Klayi version 1.1.1 or higher use with [QMK Firmware Release v0.0.2](https://github.com/nomisolutions/vial-qmk/tree/v0.0.2klayi)
- Klayi version 1.0.0 or higher use with [QMK Firmware Release v0.0.1](https://github.com/nomisolutions/vial-qmk/releases/tag/v0.0.1klayi)

## ZSA Moonlander
Keyboard official website [Moonlander](https://www.zsa.io/moonlander)

- Klayi version 1.2.0 use with [QMK/ZSA Firmware Release v0.1.2](https://github.com/nomisolutions/qmk_firmware)
- Klayi version 1.3.0 works out-of-box, no firmware flashing required (uses the built-in Moonlander Oryx protocol).
